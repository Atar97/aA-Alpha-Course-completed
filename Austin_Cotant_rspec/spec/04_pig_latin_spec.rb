...
describe "#translate" do
  ...
  it "translates capitalized sentences and keeps the capitalization the same" do
    s = translate("Alisha is my Best Friend")
    expect(s).to eq("Alishaay isay myay Estbay Iendfray")
  end
end
