...
def gcd_of_last_digits(int_one, int_two)
  return last_digit(int_two).gcd(last_digit(int_one))
end
...
def dec_remainder_of_two_floats(f_dividend, f_divisor)
  divided = f_dividend/f_divisor
  return divided - divided.floor
end
...
def int_remainder_without_modulo(i_dividend, i_divisor)
  # while i_dividend > i_divisor
      # i_dividend = i_dividend - i_divisor
    # end
    # return i_dividend
    # this whole section of code should work but slowly
    thing = dec_remainder_of_two_integers(i_dividend, i_divisor)
    return (thing * i_divisor).round
end
