...
class Course
  def initialize(course_name = '#Course', department = nil, credits = 0,
    days = [], blocktime = 0)
    @students = []
    @name = course_name
    @meeting_time = {}
  ...
  attr_accessor :students, :name, :meeting_time, :department, :credits
  attr_accessor :days, :time_block
